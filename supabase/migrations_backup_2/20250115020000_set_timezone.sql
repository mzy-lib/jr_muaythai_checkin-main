...
-- Add comment explaining the timezone setting
COMMENT ON DATABASE postgres IS 'Database timezone is set to Asia/Bangkok to match gym location';

-- Drop existing trigger
DROP TRIGGER IF EXISTS check_in_validation_trigger ON check_ins;

-- Update validate_check_in function to include timezone setting
