-- Enhanced check-in validation with new member handling
...
BEGIN
  ...
  -- First check if this is a new member
  IF v_is_new_member THEN
    -- New members can check in once as regular check-in
    SELECT COUNT(*)
